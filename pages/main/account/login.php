  ...
  <div  class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="./assets/image/banner/signin.jpg"
          class="img-fluid" alt="Sample image">
      </div>
      <div style=" margin-bottom: 120px;" class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="POST" action="">
         

          <div class="divider d-flex align-items-center my-4">
            <p style="font-size: 25px;" class="text-center font-weight-bold mx-3 mb-0">ĐĂNG NHẬP</p>
          </div>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <input type="submit" class="btn btn-dark btn-lg" name="login"
              style="padding-left: 2.5rem; padding-right: 2.5rem;" value="Đăng nhập">
              <p class=" font-weight-bold mt-2 pt-1 mb-0">Chưa có tài khoản?
