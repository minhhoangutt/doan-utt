            ...
            <table class="table table-striped table-checkall">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <a href="?user=change-user-info&id=<?php echo $row_Customer['ID_ThanhVien']?>" class="btn btn-danger btn-sm rounded text-white mr-2" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
