            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="modules/manage_categories/add-cat.php" method="POST">
                        ...
                        <input type="submit" class="btn btn-danger" name="add" value="Thêm mới">
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            while ($row_category_product=mysqli_fetch_array($query_category_product)) {
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="?cat=fix-cat&id=<?php echo $row_category_product['ID_DanhMuc']?>" class="btn btn-danger btn-sm text-white mr-2" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
