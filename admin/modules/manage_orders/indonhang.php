<?php
	...
	$pdf->Ln(15);
    $pdf->Write(10,'Mã đơn hàng: '.$row_order['CodeOrder']. '');
    $pdf->Ln(10);
    $pdf->Write(10,'Khách hàng: '.$row_order['NguoiNhan'].' ');$pdf->Ln(10);
    $pdf->Write(10,'Số điện thoại: '.$row_order['SoDienThoai']);
	$pdf->Ln(10);
    $pdf->Write(10,'Địa chỉ: '.$row_order['DiaChi'].' ');$pdf->Ln(10);
    $pdf->Write(10,'Thời gian: '.$row_order['ThoiGianLap']);
	$pdf->Ln(10);
    $pdf->Write(10,'Hình thức thanh toán: '.$row_order['HinhThucThanhToan']);
	$pdf->Ln(10);
    
    $pdf->Write(10,'Đơn hàng gồm có:');
	$pdf->Ln(10);
	...
	$pdf->Cell($width_cell[3],10,'Giá bán',1,0,'C',true);
    ...
    $pdf->Ln(10);
    $pdf->Write(10,'Cảm ơn bạn đã mua hàng !');
	$pdf->Ln(10);
    $pdf->Output();
?>