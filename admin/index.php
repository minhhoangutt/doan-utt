...
<html lang="vi">
    ...
    <body>
        <div id="warpper" class="nav-fixed">
            <nav style="background-color: #000;" class="topnav shadow navbar-light  d-flex">
                <div  class="navbar-brand"><a class="text-danger" href="index.php">TRANG QUẢN LÝ</a></div>
                <div class="nav-right">
            ...
            <div id="page-body" class="d-flex">
                <div id="sidebar" class="bg-white">
                    <ul id="sidebar-menu">
                        ...
                        <li>
                            <div class="nav-link">
                            <a href="?cat=cat-product"> <div class="nav-link-icon d-inline-flex">
                                    <i class="far fa-folder"></i>
                                </div> Danh mục</a>
                            </div>
                        </li>
                            ...
                            <a href="?user=list-user">
                                ...
                                Tài khoản
                                    ...
                                    <a href="?user=comments"
                                        ><i class="far fa-folder"></i> Bình luận</a
                                    >
                            
                        </li> 
                        </li>
                        <li class="nav-link">
                            <a href="?feedback=list-feedback">
                                <div class="nav-link-icon d-inline-flex">
                                    <i class="far fa-folder"></i>
                                </div>
                                Phản hồi
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="?feedback=list-seen">Phản hồi</a></li>
                ...
                <div style="background-color: #fff;" id="wp-content">
                <?php
                if(isset($_GET['user'])){
                    $user = $_GET['user'];
                    ...
                    require "modules/manage_feedbacks/{$feedback}.php";
                }
                else {
